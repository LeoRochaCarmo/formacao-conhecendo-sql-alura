...
csv_file1 = 'C:/Users/leona_xuct80p/Desktop/Estudos/Alura/Formação Conhecendo SQL/SQLite_online-conhecendo_instruções_SQL/dados/tabela_fornecedores.csv'
csv_file2 = 'C:/Users/leona_xuct80p/Desktop/Estudos/Alura/Formação Conhecendo SQL/SQLite_online-conhecendo_instruções_SQL/dados/tabela_pedidos.csv'

# Nome do arquivo SQLite
db_file = 'C:/Users/leona_xuct80p/Desktop/Estudos/Alura/Formação Conhecendo SQL/hermex.db'
...
if not os.path.exists(csv_file1):
    ...
    df1.to_sql('fornecedores', conn, if_exists='replace', index=False)
